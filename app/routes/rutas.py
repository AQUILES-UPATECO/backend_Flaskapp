...
from ..controllers.controller import ActorController

actor_bp = Blueprint("actor_bp", __name__)

actor_bp.route("/ejemplo/<int:actor_id>", methods=["GET"])(ActorController.get_actor)
actor_bp.route("/ejemplo", methods=["POST"])(ActorController.create_actor)
# actor_bp.route('/actors', methods = ['GET'])(ActorController.get_actors)
